...
public class page_3a_dd extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_dd frame = new page_3a_dd();
	...
	public page_3a_dd() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_dd.class.getResource("/image/hospital-icon.png")));
		...
		JLabel lblAddPatient = new JLabel("Update Accountant");
		lblAddPatient.setBounds(10, -1, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_dd.class.getResource("/image/Supervisor-icon.png")));
		...
		button_1.setIcon(new ImageIcon(page_3a_dd.class.getResource("/image/search-red-icon.png")));
		...
		button.setIcon(new ImageIcon(page_3a_dd.class.getResource("/image/arrow-back-1-icon.png")));
