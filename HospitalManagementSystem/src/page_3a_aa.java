...
public class page_3a_aa extends JFrame {
	...
	public page_3a_aa() {
		...
		JLabel lblAddPatient = new JLabel("Patient Details");
		lblAddPatient.setBounds(169, 11, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_aa.class.getResource("/image/Actions-view-list-details-icon.png")));
