...
public class page_3e_vi extends JFrame {
	...
	public page_3e_vi() {
		...
		JLabel lblAddPatient = new JLabel("Doctor Details");
		lblAddPatient.setBounds(169, 11, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3e_vi.class.getResource("/image/People-Doctor-Male-icon.png")));
