...
public class page_3e_i extends JFrame {
	...
	public page_3e_i() {
		...
		textArea.setBounds(20, 70, 321, 22);
		panel_2.add(textArea);
		
		JLabel lblAddPatient = new JLabel("Add Patient");
		lblAddPatient.setBounds(10, 11, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3e_i.class.getResource("/image/user-add-icon.png")));
