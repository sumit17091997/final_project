...
public class page_3a_bb extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_bb frame = new page_3a_bb();
	...
	public page_3a_bb() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_bb.class.getResource("/image/hospital-icon.png")));
		...
		JLabel lblAddPatient = new JLabel("Add Nurse");
		lblAddPatient.setBounds(10, -1, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_bb.class.getResource("/image/nurse-icon.png")));
		...
		button.setIcon(new ImageIcon(page_3a_bb.class.getResource("/image/arrow-back-1-icon.png")));
