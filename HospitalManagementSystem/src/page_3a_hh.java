...
public class page_3a_hh extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_hh frame = new page_3a_hh();
	...
	public page_3a_hh() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_hh.class.getResource("/image/hospital-icon.png")));
		...
		lblAddPatient.setIcon(new ImageIcon(page_3a_hh.class.getResource("/image/People-Doctor-Male-icon.png")));
		...
		JLabel lblAddressLine_1 = new JLabel("Specalization :");
		...
		button.setIcon(new ImageIcon(page_3a_hh.class.getResource("/image/arrow-back-1-icon.png")));
