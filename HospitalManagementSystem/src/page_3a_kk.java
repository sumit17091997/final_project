...
public class page_3a_kk extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_kk frame = new page_3a_kk();
	...
	public page_3a_kk() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_kk.class.getResource("/image/hospital-icon.png")));
		...
		JLabel lblAddPatient = new JLabel("Update Doctor");
		lblAddPatient.setBounds(10, -1, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_kk.class.getResource("/image/People-Doctor-Male-icon.png")));
		...
		button_1.setIcon(new ImageIcon(page_3a_kk.class.getResource("/image/search-red-icon.png")));
		...
		button.setIcon(new ImageIcon(page_3a_kk.class.getResource("/image/arrow-back-1-icon.png")));
