...
public class page_3a_ee extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_ee frame = new page_3a_ee();
	...
	public page_3a_ee() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_ee.class.getResource("/image/hospital-icon.png")));
		...
		JLabel lblAddPatient = new JLabel("Add Accountant");
		lblAddPatient.setBounds(10, -1, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_ee.class.getResource("/image/Supervisor-icon.png")));
		...
		button.setIcon(new ImageIcon(page_3a_ee.class.getResource("/image/arrow-back-1-icon.png")));
