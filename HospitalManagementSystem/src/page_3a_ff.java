...
public class page_3a_ff extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					page_3a_ff frame = new page_3a_ff();
	...
	public page_3a_ff() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(page_3a_ff.class.getResource("/image/hospital-icon.png")));
		...
		textArea.setBounds(20, 52, 321, 22);
		panel_2.add(textArea);
		
		JLabel lblAddPatient = new JLabel("Add Receptionist");
		lblAddPatient.setBounds(10, -1, 331, 36);
		lblAddPatient.setIcon(new ImageIcon(page_3a_ff.class.getResource("/image/receptionist-icon.png")));
		...
		textArea_6.setBounds(192, 331, 149, 22);
		...
		comboBox.setBounds(20, 329, 160, 25);
		...
		button.setIcon(new ImageIcon(page_3a_ff.class.getResource("/image/arrow-back-1-icon.png")));
